...
import cc.chordflower.weasel.utils.reflection.*;
...
public class MirroredConstructorInformation extends ConstructorInformation {

  protected final ExecutableElement method;

  protected final String name;

  protected final ImmutableSet< TypeModifiersEnum > modifiers;

  protected ImmutableMultiset< Annotation > annotations;

  protected ImmutableSet< ParameterInformation< ? > > parameters;

  public MirroredConstructorInformation( @NotNull ExecutableElement method, boolean initialized ) {
  ...
  public boolean equals( Object o ) {
    ...
    MirroredConstructorInformation that = ( MirroredConstructorInformation ) o;
